    ...
    <div class="main">
        <div class="d-flex flex-wrap justify-content-between align-items-center mb-3 gap-2">
            ...
            <div class="d-flex align-items-center gap-2">
                ...
                <button class="btn btn-primary" type="button" data-bs-toggle="collapse" data-bs-target="#addProductCollapse" aria-expanded="false" aria-controls="addProductCollapse">Add Product</button>
            </div>
        </div>
        ...
        <div class="collapse show" id="addProductCollapse">
            <div class="card mb-3">
                <div class="card-body">
                    ...
                    <form method="POST" class="row g-3 mt-1">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" name="code" class="form-control" placeholder="e.g. WM-100" required>
                        </div>
                        <div class="col-md-4">
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="number" name="quantity" class="form-control" placeholder="e.g. 25" min="0" required>
                        </div>
                        <div class="col-12">
        ...
        <script>
            // Client-side search filter by name/code
